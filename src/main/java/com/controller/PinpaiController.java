...
public class PinpaiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,PinpaiEntity pinpai, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,PinpaiEntity pinpai, HttpServletRequest request){
        EntityWrapper<PinpaiEntity> ew = new EntityWrapper<PinpaiEntity>();
    	PageUtils page = pinpaiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, pinpai), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
