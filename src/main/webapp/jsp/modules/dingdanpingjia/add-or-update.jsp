						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>商品分类</label>
										<input id="shangpinfenlei" name="shangpinfenlei" class="form-control"  value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>品牌</label>
										<input id="pinpai" name="pinpai" class="form-control"  value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>评分</label>
		...
		var crossRuleForm = {};
			...
			function shangpinmingchengSelect2Change(){
				...
				http("follow/shangpinxinxi/shangpinmingcheng","GET",{
					...
					if(res.code == 0){
						if(res.data != null && res.data.shangpinfenlei != null){
							$("#shangpinfenlei").val(res.data.shangpinfenlei);
						}
						if(res.data != null && res.data.pinpai != null){
